@extends('base')
  ...
  @section('browsertitle')Acme: Home @stop
          ...
          <div id="carousel-id" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                  <div class="item active">
                      <img alt="First slide" src="/modern/assets/img/01.jpg">
                      <div class="carousel-caption">
                          Acme Nature Tours
                      </div>
                  </div>
                  <div class="item">
                      <img alt="Second slide" src="/modern/assets/img/02.jpg">
                      <div class="carousel-caption">
                          Experience Nature as Never Before
                      </div>
                  </div>
                  <div class="item">
                      <img alt="Third slide" src="/modern/assets/img/03.jpg">
                      <div class="carousel-caption">
                          Register Now!
                      </div>
                  </div>
